...
import { obtenerMetricasEjecutivas, obtenerDrillDownEjecutivo } from '../controllers/executiveController';
...
router.get('/metrics/drilldown/:userId', obtenerDrillDownEjecutivo);
