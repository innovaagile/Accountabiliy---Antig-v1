...
exports.enviarCorreoContrato = exports.enviarCorreoReseteo = exports.enviarCorreoBienvenida = void 0;
const generarPlantillaBase = (contenidoHTML) => {
    return `
...
const enviarCorreoBienvenida = async (email, nombre, passwordTemp) => {
    const contenidoHTML = `
...
const enviarCorreoReseteo = async (email, nombre, nuevaPassword) => {
    const contenidoHTML = `
...
exports.enviarCorreoReseteo = enviarCorreoReseteo;
const enviarCorreoContrato = async (email, nombre) => {
    const contenidoHTML = `
...
exports.enviarCorreoContrato = enviarCorreoContrato;
